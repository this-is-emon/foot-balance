            ...
            <div class="hero min-h-screen bg-gradient-to-r from-gray-200 bg-opacity-50">
                ...
                <div class="hero-content flex-col lg:flex-row">
                    <img data-aos="fade-top"
                        ...
                        data-aos-delay="800" className='mx-auto md:mr-2' src={diagram} alt='walking pic' class="max-w-sm rounded-lg shadow-2xl" />
