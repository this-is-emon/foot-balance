    ...
    return (
        <div>
            <div class="hero min-h-screen bg-gradient-to-r from-gray-200 bg-opacity-50">
                <svg className='mb-80 hidden sm:block' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#4d7c0f" fill-opacity="0.05" d="M0,320L34.3,277.3C68.6,235,137,149,206,133.3C274.3,117,343,171,411,181.3C480,192,549,160,617,128C685.7,96,754,64,823,80C891.4,96,960,160,1029,176C1097.1,192,1166,160,1234,154.7C1302.9,149,1371,171,1406,181.3L1440,192L1440,0L1405.7,0C1371.4,0,1303,0,1234,0C1165.7,0,1097,0,1029,0C960,0,891,0,823,0C754.3,0,686,0,617,0C548.6,0,480,0,411,0C342.9,0,274,0,206,0C137.1,0,69,0,34,0L0,0Z"></path></svg>
